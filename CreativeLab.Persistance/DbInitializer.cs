    ...
    private static void SeedData(CreativeLabDbContext context)
    {
        ...
        var masterclasses = new List<Masterclass>
        {
            new() {
                ...
                Views = 1240, Rating = 4.8m, RatingsCount = 87, IsPublished = true,
            ...
            new() {
                ...
                Views = 980, Rating = 4.6m, RatingsCount = 54, IsPublished = true,
            ...
            new() {
                ...
                Views = 3100, Rating = 4.9m, RatingsCount = 210, IsPublished = true,
            ...
            new() {
                ...
                Views = 760, Rating = 4.7m, RatingsCount = 43, IsPublished = true,
            ...
            new() {
                ...
                Views = 1850, Rating = 4.8m, RatingsCount = 120, IsPublished = true,
